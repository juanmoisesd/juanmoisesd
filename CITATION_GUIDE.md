...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). GitHub Profile: Juan Moisés de la Serna Tuya — Forensic Neuroeconomist, UNIR. GitHub. https://github.com/juanmoisesd/juanmoisesd
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "GitHub Profile: Juan Moisés de la Serna Tuya — Forensic Neuroeconomist, UNIR." GitHub. https://github.com/juanmoisesd/juanmoisesd.
```
...
@misc{delaserna2026_juanmoisesd,
  ...
  title        = {GitHub Profile: Juan Moisés de la Serna Tuya — Forensic Neuroeconomist, UNIR},
  year         = {2026},
...
TI  - GitHub Profile: Juan Moisés de la Serna Tuya — Forensic Neuroeconomist, UNIR
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/juanmoisesd
...
### Vancouver / IEEE
```
de la Serna Tuya JM. GitHub Profile: Juan Moisés de la Serna Tuya — Forensic Neuroeconomist, UNIR. GitHub; 2026. Available: https://github.com/juanmoisesd/juanmoisesd. ORCID: 0000-0002-8401-8018.
```
